...
*/
public class PrediccionVolumenVentaView extends javax.swing.JPanel {
	private JLabel lblPrediccionVentas;
	...
	*/
	public static void main(String[] args) {
		...
		frame.getContentPane().add(new PrediccionVolumenVentaView(sistema));
		frame.setDefaultCloseOperation(WindowConstants.DISPOSE_ON_CLOSE);
		frame.pack();
		frame.setVisible(true);
	}
	
	public PrediccionVolumenVentaView(SistemaAdministracionGanadera sistema) {
		super();
		initGUI(sistema);
	}
	...
	private void initGUI(SistemaAdministracionGanadera sistema) {
		try {
			...
			thisLayout.setRows(7);
			this.setLayout(thisLayout);
			setPreferredSize(new Dimension(400, 300));
			{
				lblPrediccionVentas = new JLabel();
				this.add(lblPrediccionVentas);
				lblPrediccionVentas.setText("Prediccion Volumen Venta");
			}
			{
