package administracionInterfazImpl;

import java.util.Date;
import java.util.Vector;

import negocio.*;
import administracionInterfaz.AdministracionGanadera;

/**
 * Implementacion de la interfaz definida que se comunica con la base de datos
 * 
 * @author mariela
 *
 */
public class AdministracionGanaderaImpl implements AdministracionGanadera {

	/**
	 * Definir Daos a los cuales se les van a pedir los datos en la db
	 * y cuando se devuelva un dato se devuelve Rodeo no RodeoDao,
	 * el DAO solamente sirve para traer los datos de la base
	 * por ejemplo:
	 * 
	 * private RodeoDao rodeoDao;
	 * getters y setters de cada uno
	 * 
	 */
		
	private AdministracionGanaderaImpl(){
	}
	
	public AdministracionGanaderaImpl(/* pasamos todos los daos */){
		super();
		//this.rodeoDao = rodeoDao;
	}
	...
	private float sumatoriaMuertesPeriodoAnterior(Date periodoInicialAnioAnterior, Date periodoFinalAnioAnterior){
		...
		try{
			...
			System.out.println("Error al obtener datos de muertes del a�o pasado"+e.getMessage());
			System.out.println("Stack trace " +e.getStackTrace());
			return resultado;
		}
	}
	private float existenciasFinalesAnioAnterior(Date periodoInicialAnioAnterior,Date periodoFinalAnioAnterior){
		...
		try{
			...
			System.out.println("Error al obtener datos de existencias del a�o pasado"+e.getMessage());
			System.out.println("Stack trace " +e.getStackTrace());
			return resultado;
		}
	}
	...
	@Override
	public float sumatoriaExistenciaFinal(Date periodoInicial,
			Date periodoFinal, int idCategoria) {
		// TODO Auto-generated method stub
		return 0;
	}
	@Override
	public float sumatoriaTransferenciaDescarte(Date periodoInicial,
			Date periodoFinal, int idCategoria) {
		// TODO Auto-generated method stub
		return 0;
	}
	@Override
	public float sumatoriaMuertesPeriodoAnterior(
			Date periodoInicialAnioAnterior, Date periodoFinalAnioAnterior) {
		// TODO Auto-generated method stub
		return 0;
	}
	@Override
	public float existenciasFinalesAnioAnterior(
			Date periodoInicialAnioAnterior, Date periodoFinalAnioAnterior) {
		// TODO Auto-generated method stub
		return 0;
	}
	@Override
	public float muertesAnioAnterior(Date periodoInicialAnioAnterior,
			Date periodoFinalAnioAnterior) {
		// TODO Auto-generated method stub
		return 0;
	}
	@Override
	public Vector<MovimientoDeRodeo> buscarEnPeriodo(Date periodoInicial,
			Date periodoFinal) {
		// TODO Auto-generated method stub
		return null;
	}
