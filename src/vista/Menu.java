...
public class Menu extends javax.swing.JFrame {
	...
	private JMenuItem prediccionPre�ez;
		...
		try {
			...
			getContentPane().add(jPanel1);
			{
				...
				}
				{
					...
					{
						prediccionPre�ez = new JMenuItem();
						menuPredicciones.add(prediccionPre�ez);
						prediccionPre�ez.setText("Prediccion de Pre�ez");
						prediccionPre�ez.addActionListener(new ActionListener() {
							public void actionPerformed(ActionEvent evt) {
								getContentPane().remove(jPanel1);
								getContentPane().repaint();
								jPanel1=null;
								jPanel1= new PrediccionPre�ezView(sistema);
								getContentPane().add(jPanel1);
								jPanel1.repaint();
								jPanel1.updateUI();
								validate();
				...
				}
				{
					...
					menuPreniezNacimiento.setText("Relacion Pre�ez-Nacimiento");
