...
*/
public class PrediccionPreñezView extends javax.swing.JPanel {
	private JLabel lblPrediccionPrenie;
	private JLabel lblPeriodoInicial;
	private JTextField txtPreñe;
	private JLabel lblPreñez;
	...
	*/
	public static void main(String[] args) {
		...
		frame.getContentPane().add(new PrediccionPreñezView(sistema));
		frame.setDefaultCloseOperation(WindowConstants.DISPOSE_ON_CLOSE);
		frame.pack();
		frame.setVisible(true);
	}
	
	public PrediccionPreñezView(Sistema sistema) {
		super();
		initGUI(sistema);
	}
	...
	private void initGUI(Sistema sistema) {
		try {
			...
			{
				lblPrediccionPrenie = new JLabel();
				this.add(lblPrediccionPrenie);
				lblPrediccionPrenie.setText("Prediccion Preñez");
			}
			{
			...
			{
				lblPreñez = new JLabel();
				FlowLayout lblIdCatVacaLayout = new FlowLayout();
				lblPreñez.setLayout(lblIdCatVacaLayout);
				this.add(lblPreñez);
				lblPreñez.setText("Porcentaje Preñez");
				{
					txtPreñe = new JTextField();
					lblPreñez.add(txtPreñe);
					txtPreñe.setPreferredSize(new java.awt.Dimension(146, 23));
				}
			}
			{
