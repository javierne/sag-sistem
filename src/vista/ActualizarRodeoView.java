...
*/
public class ActualizarRodeoView extends javax.swing.JPanel {
	...
	*/
	public static void main(String[] args) {
		...
		frame.getContentPane().add(new ActualizarRodeoView(sistema));
		frame.setDefaultCloseOperation(WindowConstants.DISPOSE_ON_CLOSE);
		frame.pack();
		frame.setVisible(true);
	}
	
	public ActualizarRodeoView(SistemaAdministracionGanadera sistema) {
		super();
		initGUI(sistema);
	}
